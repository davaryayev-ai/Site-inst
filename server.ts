...
`;
      ...
      // ============================================================
      // STEP 1: EXTRACTION LLM — extract structured variables from conversation
      // Separate cheap LLM call (temperature=0) that reliably extracts
      // par_name, child_name, age, direction as JSON.
      // ============================================================
...
Пример: {"par_name":"Давид","child_name":"Настя","age":10,"direction":"английский"}`;
      ...
      // Run extraction and main AI in PARALLEL for speed
      ...
      // If AI confirms booking but variables are missing → block & ask
      // ============================================================
      ...
      res.json({ reply: replyText, extractedData });
    } catch (error: any) {
